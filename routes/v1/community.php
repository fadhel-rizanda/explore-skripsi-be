...
Route::prefix('communities')->group(function () {
    ...
    Route::get('/{community}', [CommunityController::class, 'communityDetail'])->middleware('model.isActive:' . ModelFlagEnum::COMMUNITY->value);

    Route::middleware(['auth:api', 'check.token.version'])->group(function () {
        Route::post('/', [CommunityController::class, 'createCommunity']);
        Route::post('/{community}/follow', [CommunityController::class, 'followCommunity'])->middleware('model.isActive:' . ModelFlagEnum::COMMUNITY->value);
